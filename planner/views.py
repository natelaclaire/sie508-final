...
def index(request):
    ...
    num_chocolate_books = Book.objects.filter(title__icontains='chocolate').count()
    num_mystery_genres = Genre.objects.filter(name__icontains='mystery').count()
    ...
    context = {
        ...
        'num_chocolate_books': num_chocolate_books,
        'num_mystery_genres': num_mystery_genres,
